...
<section id="versions-pc" class="level1">
		...
		<p>
			<span class="sidenote-wrapper">
				...
				<span class="marginnote">
					...
					<br />
					<em>MSX Magazine</em>, novembre 1988 (
	...
	<section id="rpg-tsukūru-dante-98" class="level2">
		...
		<p>
			...
			et lorsque le joueur en atteint le bord, le prochain s’affiche dans une transition similaire à
	...
	<section id="rpg-tsukūru-dante-98-ii" class="level2">
		...
		<p>
			Sortie en juillet 1996, la suite de Dante 98 devait conserver la simplicité d’utilisation de
	...
	<section id="rpg-maker-95" class="level2">
		...
		<section id="fonctionnalités" class="level3">
			...
			<p>
				Les jeux ont une résolution de 640×480 pixels, ce qui est honorable pour l’époque. On y
		...
		<section id="support" class="level3">
			...
			<p>
				...
				actuels, rendant plusieurs menus illisibles. Sur certains systèmes, les jeux plantent en
	...
	<section id="rpg-maker-xp" class="level2">
		...
		<section id="rpg-maker-xp-value" class="level3">
	...
	<section id="rpg-maker-vx" class="level2">
		...
		<section id="réception" class="level3">
			...
			<p>
				...
				musical, la simplification du logiciel créant beaucoup de limites pour les vétérans et
	...
	<section id="rpg-maker-vx-ace" class="level2">
		...
		<p>
			...
			logiciel est strictement supérieur à son prédécesseur RPG Maker VX, désormais considéré par la
	...
	<section id="rpg-maker-mv" class="level2">
		...
		<p>
			...
			ne proposaient à chaque fois qu’une seule des deux possibilités. De plus, un gestionnaire de
		...
		<section id="rpg-atsumāru" class="level3">
			...
			<p>
				...
				est un site exclusivement en japonais ouvert en 2016 et permettant de partager et jouer à
			...
			<div class="epigraph">
				<blockquote>
					<p>
						Peu d’utilisateurs japonais réalisent leurs jeux dans le but de les vendre, ce qui est
...
<section id="consoles-de-salon" class="level1">
	...
	<section id="rpg-tsukūru-super-dante" class="level2">
		...
		<p>
			Sur la carte, les personnages ont des dimensions de 16*16 pixels, ce qui était courant à
	...
	<section id="rpg-tsukūru-5-rpg-maker-2" class="level2">
		...
		<p>
			...
			disponibles pour l’éditeur : débutant, normal ou difficile.
		</p>
		<p>
	...
	<section id="rpg-tsukūru-rpg-maker-3" class="level2">
		...
		<p>
			...
			le seul épisode développé par le studio Runtime.
			<span class="sidenote-wrapper">
		...
		<p>
			...
			<span class="sidenote-wrapper">
				...
				<span class="marginnote">
					...
					coup d’épée, il recule alors que les dégâts s’affichent, puis le monstre tombe à terre si
...
<section id="consoles-portables" class="level1">
	...
	<section id="rpg-maker-gb" class="level2">
		...
		<figure>
			...
			<figcaption>RPG Maker GB – Field 1</figcaption>
		</figure>
		<p>
...
<section id="figures-majeures" class="level1">
	...
	<section id="yoji-ojima" class="level2">
		...
		<p>
			...
			<a href="#fn58" class="footnote-ref" id="fnref58" role="doc-noteref">
				<sup>58</sup>
			</a>
			et les logiciels récents continuent d’être accompagnés de la mention « Copyright KADOKAWA
			GAMES / YOJI OJIMA ». C’est donc une figure centrale dans l’histoire de la série, bien qu’il
			soit étonamment difficile de trouver des informations à son sujet.
		</p>
		<p>
			Né dans la préfecture de Kanagawa en 1977, Ojima a appris la programmation en autodidacte
			alors qu’il était à l’école. Dante 98 II est sorti alors qu’il n’avait que 19 ans ! En plus
			des RPG Maker, il a travaillé sur Zen, un programme d’IA pour le jeu Go, à partir de 2007
			environ
			<a href="#fn59" class="footnote-ref" id="fnref59" role="doc-noteref">
				<sup>59</sup>
			</a>. Il devint plus tard DeepZenGo
			<a href="#fn60" class="footnote-ref" id="fnref60" role="doc-noteref">
				<sup>60</sup>
			</a>.
		</p>
		<p>
			<span class="sidenote-wrapper">
				<label for="sn-56" class="margin-toggle">
					&#8853;
				</label>
				<input type="checkbox" id="sn-56" class="margin-toggle" />
				<span class="marginnote">
					Cherry est un programmeur reconnu pour ses connaissances approfondies à propos du
					fonctionnement de RPG Maker 2000 et 2003. Il a réalisé plusieurs patchs pour étendre les
					fonctionnalités des logiciels sans avoir accès au code source de manière officielle.
					<br />
					<br />
				</span>
			</span>
		...
		<div class="epigraph">
			<blockquote>
				<p>
					On peut sentir la patte de Yoji partout, dans le code, dans l’interface et plus
					généralement dans le design et l’architecture du programme. Et j’aime beaucoup ça. Seul
					RM2003 est bizarre, et on peut clairement sentir l’absence de Yoji dans ses ajouts. […] On
					dirait vraiment que quelqu’un qui n’a aucune compréhension et aucun respect pour sa façon
					de penser et de designer des programmes a travaillé dessus (et avait sûrement un budget
					serré), ce qui a transformé certaines choses en un vrai désastre.
				</p>
				<footer>
					Cherry, rpgmaker.net
					<a href="#fn61" class="footnote-ref" id="fnref61" role="doc-noteref">
						<sup>61</sup>
					</a>
				</footer>
			</blockquote>
	...
	<section id="autres-crédits" class="level2">
		<h2>Autres crédits</h2>
		<p>
			RPG Maker Dante 98 est écrit par Nobuyuki Yamashita. RPG Maker 95 est programmé par You Ito et
			Tsuneari Okumoto. Les parties uniques à RPG Maker 2003 sont écrites par 濱田信次 (Shinji
			Hamada ?)
			<a href="#fn62" class="footnote-ref" id="fnref62" role="doc-noteref">
				<sup>62</sup>
			</a>.
		</p>
		<hr />
		<p>
			Cet article utilise <a href="https://github.com/jez/tufte-pandoc-css">Tufte Pandoc CSS</a>, un
			projet basé sur <a href="https://edwardtufte.github.io/tufte-css/">Tufte CSS</a>.
		</p>
	</section>
</section>
<section class="footnotes footnotes-end-of-document" role="doc-endnotes">
	...
	<ol>
		<li id="fn1" role="doc-endnote">
			<p>
				ツクール概要, ツクールweb (
				<a href="http://web.archive.org/web/20100601165042/http://tkool.jp/outline/">archive</a>)
		...
		<li id="fn2" role="doc-endnote">
			<p>
				ツクール博物館, ツクールweb (
				<a href="https://web.archive.org/web/20070823073359/http://www.enterbrain.co.jp/tkool/museum.html">
					archive
				</a>
		...
		<li id="fn3" role="doc-endnote">
			<p>
				<a href="http://www.8-bits.info/gamelist/PC88/info/info_Dq0aLbayw8i0gM7b.php">
					ダンジョン万次郎
				</a>
				, 8-bits.info
		...
		<li id="fn4" role="doc-endnote">
			<p>
				<a href="http://msx.jpn.org/tagoo/s_check.cgi?LINE=1511">ダンジョン万次郎</a>, Tagoo
		...
		<li id="fn5" role="doc-endnote">
			<p>
				<a href="http://www.8-bits.info/gamelist/PC88/info/info_DLjnk9rS0IqKAwe4.php">
					RPGツクール まみりん
				</a>
				, 8-bits.info
		...
		<li id="fn6" role="doc-endnote">
			<p>
				<a href="http://www.uraken.net/zatsugaku/zatsugaku_60.html">
					ゲームを作ろう！（２）RPGツクールでつくーる
				</a>
				, uraken.net
		...
		<li id="fn8" role="doc-endnote">
			<p>
				<em>MSX Magazine</em>, février 1990, p. 76 (
				<a href="https://archive.org/details/MSX_Magazine_1990-02_ASCII_JP/page/n75">archive</a>)
		...
		<li id="fn9" role="doc-endnote">
			<p>
				<em>MSX Magazine</em>, février 1990, p. 88 (
				<a href="https://archive.org/details/MSX_Magazine_1990-02_ASCII_JP/page/n87">archive</a>)
		...
		<li id="fn10" role="doc-endnote">
			<p>
				<em>MSX Magazine</em>, février 1992, p. 48 (
				<a href="https://archive.org/details/MSX_Magazine_1992-02_ASCII_JP/page/n47">archive</a>)
		...
		<li id="fn11" role="doc-endnote">
			<p>
				Koji Fukuyama,
				<a href="https://automaton-media.com/articles/reportjp/20180805-73517/">
					MSX愛＆インディー精神を貫いてきたNIGOROのこれまでの道のり。『LA-MULANA
					2』の完成記念イベント「LA-MULANA 通の会」レポート
				</a>, AUTOMATON, 5 août 2018<a href="#fnref11" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn12" role="doc-endnote">
			<p>
				<em>MSX Magazine</em>, mai 1992, p. 79 (
				<a href="https://archive.org/details/MSX_Magazine_1992-05_ASCII_JP/page/n77">archive</a>)
		...
		<li id="fn13" role="doc-endnote">
			<p>
				RPGツクールの歴史, ツクール (
				<a href="https://web.archive.org/web/20070717234604/http://www.enterbrain.co.jp/tkool/histry.html">
					archive
				</a>
		...
		<li id="fn14" role="doc-endnote">
			<p>
				<a href="https://w.atwiki.jp/gcmatome/pages/1911.html">RPGツクールDante98</a>,
				ゲームカタログ@Wiki
		...
		<li id="fn16" role="doc-endnote">
			<p>
				<a href="https://en.wikipedia.org/wiki/RPG_Maker">
					<em>RPG Maker</em>
				</a>
				, Wikipedia
		...
		<li id="fn17" role="doc-endnote">
			<p>
				<a href="http://www.rpg-maker.fr/wiki-23-rpg-maker-95.html">
					<em>RPG Maker 95</em>
				</a>
				, wiki d’Oniromancie
				<a href="#fnref17" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn18" role="doc-endnote">
			<p>
				<a href="http://www.rpg-maker.fr/decouvrir-logiciel-rm95.html">
					<em>Découvrir les logiciels : RPG Maker 95</em>
				</a>
				, Oniromancie
		...
		<li id="fn19" role="doc-endnote">
			<p>
				<a href="https://ja.wikipedia.org/wiki/RPG%E3%83%84%E3%82%AF%E3%83%BC%E3%83%AB95">
					RPGツクール95
				</a>
				, Wikipedia
				<a href="#fnref19" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn20" role="doc-endnote">
			<p>
				BilouMaster, <a href="https://github.com/BilouMaster/buildozer">buildozer</a>, GitHub, mis à
				jour le 26 février 2018
				<a href="#fnref20" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn21" role="doc-endnote">
			<p>
				Nuki,
				<a href="https://e-magination.jeun.fr/t3204-joke-nous-offre-sa-vision">
					<em>Joke nous offre sa vision</em>
				</a>, E-magination Games, 22 février 2010<a
					href="#fnref21"
					class="footnote-back"
					role="doc-backlink"
				>
		...
		<li id="fn22" role="doc-endnote">
			<p>
				<a href="https://www.rpg-maker.fr/index.php?page=news&amp;id=226">Commentaire d’elm6</a>,
				Oniromancie, 3 février 2011 à 12:48:18
				<a href="#fnref22" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn23" role="doc-endnote">
			<p>
				<a href="https://forums.rpgmakerweb.com/index.php?threads/rpg-maker-mv-500k-midweek-madness-sales-map-madness-event.134680/">
					<em>RPG Maker MV 500k Midweek Madness Sales + Map Madness Event!</em>
				</a>
				, RPG Maker Forums, 24 mars 2021
				<a href="#fnref23" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn24" role="doc-endnote">
			<p>
				<a href="https://wiki.denfaminicogamer.jp/tkoolmv/RPG%E3%82%A2%E3%83%84%E3%83%9E%E3%83%BC%E3%83%AB%E3%81%AB%E3%81%A4%E3%81%84%E3%81%A6">
					RPGアツマールについて
				</a>
				, RPGツクールMVまとめwiki
				<a href="#fnref24" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn25" role="doc-endnote">
			<p>
				<a href="https://atsumaru.github.io/api-references/download/200x-player">
					RPGツクール2000/2003プレイヤー
				</a>
				, ゲームアツマール APIリファレンス, consulté le 28 juin 2021
				<a href="#fnref25" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn26" role="doc-endnote">
			<p>
				戸塚伎一,
				<a href="https://www.famitsu.com/news/201704/29132229.html">
					PC版『RPGツクール』100万本突破記念インタビュー！
					Steamでの展開やコミュニティの活性化がヒットにつながった
				</a>, ファミ通.com, 29 avril 2017<a
					href="#fnref26"
					class="footnote-back"
					role="doc-backlink"
				>
		...
		<li id="fn27" role="doc-endnote">
			<p>
				<a href="https://www.giantbomb.com/kuusou-kagaku/3010-6849/">
					<em>Kuusou Kagaku (company)</em>
				</a>
				, Giant Bomb
				<a href="#fnref27" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn28" role="doc-endnote">
			<p>
				<a href="https://fr.wikipedia.org/wiki/Agetec">
					<em>Agetec</em>
				</a>
				, Wikipédia
				<a href="#fnref28" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn29" role="doc-endnote">
			<p>
				<a href="https://en.wikipedia.org/wiki/Turbo_File_(ASCII)">
					<em>Turbo File (ASCII)</em>
				</a>
				, Wikipedia
		...
		<li id="fn30" role="doc-endnote">
			<p>
				<a href="https://satellaview.fandom.com/wiki/RPG_Tsuk%C5%ABru_2">
					<em>RPG Tsukūru 2</em>
				</a>
		...
		<li id="fn31" role="doc-endnote">
			<p>
				<a href="https://god-bird.net/research/satellaoriginal.html">
					サテラビューのオリジナルゲームの一覧。
				</a>
				, GOD BIRD
				<a href="#fnref31" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn32" role="doc-endnote">
			<p>
				<a href="https://satellaview.fandom.com/wiki/Slotted_cartridge">
					<em>Slotted cartridge</em>
				</a>
				, The English Satellaview Wiki
				<a href="#fnref32" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn33" role="doc-endnote">
			<p>
				...
				<a href="#fnref33" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn34" role="doc-endnote">
			<p>
				Topic
				<a href="https://forums.rpgmakerweb.com/index.php?threads/rpgmaker-1-2-and-3.80421/">
					« RPG Maker 1, 2 and 3 »
				</a>
				sur RPG Maker Forums
				<a href="#fnref34" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn35" role="doc-endnote">
			<p>
				https://w.atwiki.jp/gcmatome/pages/3854.html
				<a href="#fnref35" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn36" role="doc-endnote">
			<p>
				もか,
				<a href="https://news.denfaminicogamer.jp/gamenewsplus/200422c">
					『ドラクエ7』を4分でクリアするために必要なのは『RPGツクール3』。お絵かきツール「アニメティカ」と「メモリーカード」による攻略の歴史
				</a>, 電ファミニコゲーマー, 22 avril 2020<a
					href="#fnref36"
					class="footnote-back"
					role="doc-backlink"
				>
		...
		<li id="fn37" role="doc-endnote">
			<p>
				https://w.atwiki.jp/gcmatome/pages/3854.html
				<a href="#fnref37" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn38" role="doc-endnote">
			<p>
				https://w.atwiki.jp/gcmatome/pages/3854.html
				<a href="#fnref38" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn39" role="doc-endnote">
			<p>
				...
				sur RPG Maker Forums
				<a href="#fnref39" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn40" role="doc-endnote">
			<p>
				昔は「アージェント」と名乗っていなかった？, agenda-game.com, 28 juin 2007 (
				<a href="https://web.archive.org/web/20110909161042/http://agenda-game.com/about/faq/000974.html">
					archive
				</a>
				)<a href="#fnref40" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn41" role="doc-endnote">
			<p>
				製品情報（目次）, agenda-game.com (
				<a href="https://web.archive.org/web/20110811054013/http://agenda-game.com/products/">
					archive
				</a>
				)<a href="#fnref41" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn42" role="doc-endnote">
			<p>
				<a href="https://psxdatacenter.com/games/J/R/SLPS-02861.html">
					<em>RPG Tsukuru 4</em>
				</a>
				, The Playstation Datacenter
				<a href="#fnref42" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn43" role="doc-endnote">
			<p>
				TheUnproPro,
				<a href="https://www.youtube.com/watch?v=h4k7ZRAlC7A">
					<em>RPG maker 2</em>
				</a>
				, 0:48 à 1:50, YouTube
				<a href="#fnref43" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn44" role="doc-endnote">
			<p>
				Matthew Scribner,
				<a href="https://archive.rpgamer.com/games/rpgm/rpgm2/rpgm2prev.html">
					<em>Preview: RPG Maker 2</em>
				</a>, RPGamer<a href="#fnref44" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn45" role="doc-endnote">
			<p>
				...
				<a href="#fnref45" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn46" role="doc-endnote">
			<p>
				https://w.atwiki.jp/gcmatome/pages/2229.html
				<a href="#fnref46" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn47" role="doc-endnote">
			<p>
				<a href="https://www.romhacking.net/translations/42/">
					<em>Translations - RPG Tsukuru GB</em>
				</a>
				, Romhacking.net
				<a href="#fnref47" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn48" role="doc-endnote">
			<p>
				<a href="http://tukutuku-con.blogspot.com/2019/03/blog-post.html">RPGツクールGB</a>,
				RPGツクールの森, 28 mars 2019
				<a href="#fnref48" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn49" role="doc-endnote">
			<p>
				<a href="http://tabiteam.s16.xrea.com/gbkouza-situmon.html">
					RPGツクールGB講座 - よくある質問
				</a>
				, TABITEAM
				<a href="#fnref49" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn50" role="doc-endnote">
			<p>
				Résultats du concours, tkool.jp (
				<a href="http://web.archive.org/web/20080217005320/http://tkool.jp/products/rpggb/tagkon/tagkon_2.html">
					archive
				</a>
				)<a href="#fnref50" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn51" role="doc-endnote">
			<p>
				<a href="https://ja.wikipedia.org/wiki/RPG%E3%83%84%E3%82%AF%E3%83%BC%E3%83%AB">
					RPGツクール
				</a>
				, Wikipedia
				<a href="#fnref51" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn52" role="doc-endnote">
			<p>
				<a href="http://tukutuku-con.blogspot.com/2019/09/rpggb2.html">RPGツクールGB2</a>,
				RPGツクールの森, 9 septembre 2019
				<a href="#fnref52" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn53" role="doc-endnote">
			<p>
				<a href="http://tukutuku-con.blogspot.com/2019/09/rpggb2.html">RPGツクールGB2</a>,
				RPGツクールの森, 9 septembre 2019
				<a href="#fnref53" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn54" role="doc-endnote">
			<p>
				<a href="http://tabiteam.s16.xrea.com/gbkouza-seihin.html">RPGツクールGB講座 - 製品紹介</a>,
				TABITEAM
				<a href="#fnref54" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn55" role="doc-endnote">
			<p>
				...
				)<a href="#fnref55" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn56" role="doc-endnote">
			<p>
				Puyo,
				<a href="https://www.gamekult.com/actualite/rpg-maker-advance-retarde-22421.html">
					<em>RPG Maker Advance retardé</em>
				</a>, Gamekult, 9 décembre 2002<a href="#fnref56" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn57" role="doc-endnote">
			<p>
				<a href="https://rpgmaker.net/forums/topics/24958/?post=898942#post898942">
					Post de Dragon_Kamillo
				</a>
				sur le forum de rpgmaker.net<a href="#fnref57" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		...
		<li id="fn59" role="doc-endnote">
			<p>
				株式会社 毎日コミュニケーションズ, 『「第14回
				コンピュータオリンピアード」優勝の思考エンジンを搭載した最強ソフトWindows向け囲碁対局ソフト『天頂の囲碁』を9月18日に発売』,
				News2u.net, 11 septembre 2009 (
				<a href="http://web.archive.org/web/20100429060824/http://www.news2u.net/releases/56419/items/4/">
					archive
				</a>
				)<a href="#fnref59" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn60" role="doc-endnote">
			<p>
				<a href="https://ja.wikipedia.org/wiki/DeepZenGo">
					<em>DeepZenGo</em>
				</a>
				, Wikipedia
				<a href="#fnref60" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn61" role="doc-endnote">
			<p>
				<a href="https://rpgmaker.net/forums/topics/24958/?post=914391#post914391">
					Post de Cherry
				</a>
				, forum de rpgmaker.net, 5 novembre 2020
				<a href="#fnref61" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
		<li id="fn62" role="doc-endnote">
			<p>
				...
				sur le forum de rpgmaker.net<a href="#fnref62" class="footnote-back" role="doc-backlink">
					↩︎
				</a>
			</p>
		</li>
