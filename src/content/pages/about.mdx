...
Je m'appelle <em>Aurélien Dos Santos</em>, j'ai <Age /> et je vis à <em>Toulouse</em>.
...
- Mastodon : [@aurelien@mastodon.gamedev.place](https://mastodon.gamedev.place/@aurelien)
...
J'utilise principalement un MacBook Air M1. Pour une liste de mes appareils, voir [<em>/gear</em>](/gear).

## Où vis-je

Je suis né en région parisienne avant que ma famille ne déménage dans les Landes. J'ai vécu dans des appartements étudiants à Pau pour suivre mes premières études, puis j'ai déménagé à Toulouse pour suivre mon Master. J'y habite toujours aujourd'hui, et je m'y sens très bien. Pour une liste de mes coins favoris, voir [<em>/places</em>](/places).

## Mes passions

Je suis amoureux du jeu vidéo. Dès l'enfance, j'étais fasciné par l'élégance des RPG japonais et la radicalité des jeux amateurs sur RPG Maker. Pendant l'adolescence, j'ai découvert le jeu PC avec l'Orange Box de Valve et le boom des jeux indépendants. J'ai pris une nouvelle claque avec The Last of Us et Destiny sur PS4, qui ont chacun à leur manière défini une génération. Par la suite, mes goûts ont été forgés par de nombreux autres jeux, avec une mention spéciale pour le multi local qui me passionne particulièrement.

import FavoriteGames from "$components/mdx/FavoriteGames.astro"

<FavoriteGames />

Ma deuxième passion est sans doute le cinéma, avec une préférence pour le naturalisme. Je m'intéresse à l'œuvre de Sophie Letourneur, Kelly Reichardt, etc. J'aime également la photographie, la programmation, la musique atmosphérique et électronique, les promenades et les cafés.
