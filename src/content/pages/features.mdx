...
- Les pages de jeu, accessibles depuis `/games`, contiennent une porte dérobée. Un double-clic sur le titre renvoie vers la page Notion qui sert à en générer le contenu.
