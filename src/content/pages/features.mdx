...
- **Ajouter une galerie des films** que j'ai mentionnés sur ce site ou aimés. C'est un problème épineux ! [Letterboxd](https://letterboxd.com/) a refusé ma demande d'accès à l'<abbr>API</abbr> ; <abbr>[IMDB](https://www.imdb.com/)</abbr> semble payant ou difficile à utiliser, mais je dois encore me pencher sur la question.
- **Ajouter un bloc pour les films.** Pour les mêmes raisons, je ne sais pas encore comment je pourrais m'y prendre.
