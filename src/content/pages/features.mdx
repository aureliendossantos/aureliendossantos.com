...
J'utilise la librairie [Medium Zoom](https://medium-zoom.francoischalifour.com/) pour permettre d'agrandir les images au clic. La _lightbox_ utilise la couleur de fond de la palette pour une expérience plus immersive.

## Blocs et mentions

### Galeries

Une galerie est une succession d'images sur la même ligne dans une _flexbox_. Actuellement, chaque élément de la _flexbox_ fait la même taille, ce qui signifie que les images doivent toutes faire la même taille pour éviter les espaces vides. Une astuce pour redimensionner les éléments de la _flexbox_ dynamiquement serait bienvenue !
...
Les _pop-ups_ peuvent contenir des informations sur un jeu ou un film (voir [<sc>IGDB</sc>](#igdb) et [<sc>TMDB</sc>](#tmdb)), notamment une affiche, les auteurs, l'année de parution et jusqu'à trois images. Une _pop-up_ s'ouvre en cliquant sur un texte dont le lien est d'une apparence plus discrète que les liens externes. Selon la palette, le lien peut être coloré ou en pointillé.
