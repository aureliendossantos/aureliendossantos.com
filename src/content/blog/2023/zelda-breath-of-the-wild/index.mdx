...
<Gallery wide>
	<Figure src={import("./shadow-of-the-colossus.png")}>Shadow of the Colossus</Figure>
	<Figure src={import("./genshin-impact.png")}>Genshin Impact</Figure>
</Gallery>
...
<Gallery wide>
	<Figure src={import("./tour.webp")}>
		Le saut depuis les tours d'observation permet de découvrir la carte.
	</Figure>
	<Figure src={import("./profondeurs.webp")}>Le monde sous-terrain.</Figure>
</Gallery>
