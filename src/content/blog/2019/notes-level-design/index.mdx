...
Voici quelques notes que j'ai prises en regardant ses vidéos sur <Popup game="nier-automata">Nier</Popup> et <Popup game="fallout-4">Fallout 4</Popup>.
...
<Gallery full>
	<Figure half src={villeTop} />
	<Figure half src={villeFoot} />
</Gallery>
...
<Gallery full>
	<Figure half src={coin1}>
		La vue depuis le coin n’est pas convaincante...
	</Figure>
	<Figure half src={coin2}>
		...mais la plupart des joueurs ne s’y aventureront pas.
	</Figure>
</Gallery>
...
<Gallery full>
	...
	<Figure half src={pdvBas}>
		Depuis le bas, les éléments du décor se confondent et paraissent plats.
	</Figure>
</Gallery>
<Gallery full>
	<Figure half src={scene}>
		Dans cette scène, le carré de lumière qui nous attire en contrebas...
	</Figure>
	<Figure half src={sceneBas}>
