...
<Gallery>
	<Figure half src={silentHillMap} alt="Capture de la carte du jeu de Silent Hill">
		Silent Hill
	</Figure>
	<Figure half src={tlou2Map} alt="Capture du jeu présentant la carte de la zone ouverte de TLOU2">
		The Last of Us Part II
	</Figure>
</Gallery>
...
[^PremierArticle]:
    <BlogRef slug="2020/the-last-of-us" />
