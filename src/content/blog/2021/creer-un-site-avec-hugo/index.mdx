...
categories: ["Tutoriel"]
tags: ["Web"]
image: ../content/blog/2021/creer-un-site-avec-hugo/halgatewood-unsplash.jpg
toc: true
palette: guidebook
---
...
<Figure src={hugo} alt="Logo de Hugo" />
...
import typora from "./typora.png"

<Figure src={typora} alt="Capture d'écran de Typora">
	Typora est un éditeur de texte élégant combinant les intérêts de l'écriture en Markdown avec un
...
import bigspring from "./bigspring.png"
import portio from "./portio.png"
import bookworm from "./bookworm.png"
import stack from "./stack.png"

<Gallery wide>
	<Figure src={bigspring}>
		[Bigspring](https://themes.gohugo.io/bigspring-hugo-startup-theme/), un thème pour les agences
		du web
	</Figure>
	<Figure src={portio}>
		[Portio](https://themes.gohugo.io/portio-hugo/), un portfolio au design chaleureux
	</Figure>
</Gallery>
<Gallery wide>
	<Figure src={bookworm}>
		[Bookworm](https://github.com/gethugothemes/bookworm), pour les blogs audacieux et légers
	</Figure>
	<Figure src={stack}>
		[Stack](https://github.com/CaiJimmy/hugo-theme-stack), que j'utilise sur ce site !
	</Figure>
</Gallery>

<Note>
	**Mise à jour :** Je n'utilise plus le thème Stack sur ce site aujourd'hui, car j'ai développé mon
	propre design[^redesign] puis j'ai migré de Hugo vers Astro[^astro].
	
	[^redesign]: <ArticleRef slug="2022/nouveau-design-de-blog" />
	[^astro]: <ArticleRef slug="2023/refonte-astro" />
...
<Tabs>
<Fragment slot="tab-1">Windows 10 et 11</Fragment>
...
import p1 from "./variables-d-environnement.png"
import p2 from "./modifier-path.png"
import p3 from "./ajouter-dossier.png"
import p4 from "./ouvrir-cmd.png"
...
<Figure src={anubis}>Anubis est un thème de blog minimaliste.</Figure>

<Note>
	Si vous êtes un utilisateur de git, il peut être plus intéressant d'ajouter les thèmes en tant que
	submodule.
</Note>
...
<Note>
	Pour redémarrer rapidement le serveur, faites Ctrl+C pour l'arrêter, flèche du haut pour réécrire
	la commande, puis Entrée pour valider.
</Note>
...
<Figure
	src={vscode}
	alt="Fenêtre de Visual Studio Code avec l'arborescence des fichiers ouverte à gauche."
>
	Ouvrir un dossier avec Visual Studio Code permet d'afficher une arborescence des fichiers sur le
	côté, mais aussi d'ouvrir un terminal directement à l'emplacement du dossier.
</Figure>
...
<Note>
	La commande `hugo` ne vide pas le dossier `public` avant de reconstruire le site. Veillez donc à
	supprimer le dossier `public` vous-même avant de lancer `hugo`, ou vous risqueriez d'y laisser
	d'anciens fichiers privés ou des brouillons.
</Note>
...
<Tabs>
<Fragment slot="tab-1">Avec GitHub Desktop</Fragment>
<Fragment slot="tab-2">Avec git</Fragment>

<Fragment slot="panel-1-tallest">
...
<Tabs id="publier repo" >
	<Fragment slot="tab-1">Code source public</Fragment>
<Fragment slot="tab-2">Code source privé</Fragment>
<Fragment slot="panel-1">
