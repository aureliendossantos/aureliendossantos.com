...
<Popup game="destiny">Destiny</Popup> est un FPS sorti sur consoles en 2014 et dont vous avez sans doute
déjà entendu parler, d'abord en raison de son budget com' et puis parce que c'est un jeu important :
il a, sous bien des aspects, influencé l'industrie du jeu vidéo. Quand je l'ai découvert, j'ai été impressionné
dès l'introduction, qui me fascine encore aujourd'hui. A vrai dire, c'est peut-être mon moment de jeu
vidéo préféré.
...
<Note>
	Notez que ce niveau d'introduction a ensuite été réutilisé dans
	<Popup game="destiny-2">Destiny 2</Popup>, mais quelques changements rendent l'expérience moins élégante
	et moins efficace, donc nous ne nous attarderons pas dessus. Egalement, j'accorderai « le joueur »
	au masculin pour faciliter la lecture et vous prie de m'excuser pour toute gêne occasionnée.
</Note>
...
import thVideoIntro from "./th-video-intro.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/video-intro.webm" controls poster={thVideoIntro.src} />
</Gallery>
...
import thCineIntro from "./th-cinematique-intro.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/cinematique-intro.webm" controls poster={thCineIntro.src} />
</Gallery>
...
<Gallery wide>
	<Video src="/videos/2021/destiny/1.webm" poster={th1.src} controls />
</Gallery>
...
import chemin1 from "./chemin1.jpg"
import chemin3 from "./chemin3.jpg"

<Gallery full>
	<Figure third src={th1} />
	<Figure third src={chemin1} />
	<Figure third src={chemin3} />
</Gallery>
...
import radar1 from "./radar1.jpg"
import radar2 from "./radar2.jpg"

<Gallery full>
	<Figure half src={radar1} />
	<Figure half src={radar2} />
</Gallery>
...
<Gallery wide>
	<Video src="/videos/2021/destiny/2.webm" poster={th2.src} controls />
</Gallery>
...
import ff7 from "./ff7.webp"

<Figure src={ff7} alt="Capture d'écran d'un tutoriel de FF7 Remake">
	Encore aujourd'hui, de nombreux jeux, comme
	<Popup game="final-fantasy-vii-remake">*Final Fantasy VII Remake*</Popup> ici, nous retirent régulièrement
	le contrôle pour nous apprendre des actions très simples. Cela vient probablement en partie d'une crainte
	que le grand public ne comprenne pas le jeu, mais c'est au final contre-productif puisqu'on intègre
	mieux l'information en expérimentant directement.
</Figure>
...
<Gallery wide>
	<Video src="/videos/2021/destiny/3.webm" poster={th3.src} controls />
</Gallery>
...
<Figure src={schema} alt="Schéma de l'arène" rounded>
	Les carrés noirs représentent les grands piliers et les autres obstacles plus hauts que le
	personnage. Les ronds rouges indiquent la position de départ des ennemis.
</Figure>
...
<Gallery wide>
	<Video src="/videos/2021/destiny/4.webm" poster={th4.src} controls />
</Gallery>
...
<Gallery wide>
	<Video src="/videos/2021/destiny/5.webm" poster={th5.src} controls />
</Gallery>
...
import th6 from "./th6.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/6.webm" poster={th6.src} controls />
</Gallery>
...
import th7 from "./th7.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/7.webm" poster={th7.src} controls />
</Gallery>
...
import open0 from "./open0.webp"
import open1 from "./open1.webp"
import open2 from "./open2.webp"

<Gallery full>
	<Figure third src={open0}>
		En arrivant, la composition transforme le côté droit en une sorte de mur, nous invitant à
		regarder vers l'avant puis au fond à gauche.
	</Figure>
	<Figure third src={open1}>
		Si l'on regarde tout de même à droite, notre regard va « glisser » le long des obstacles.
	</Figure>
	<Figure third src={open2}>
		Une fois en bas, la pente rend le passage encore moins visible.
	</Figure>
</Gallery>
...
import th8 from "./th8.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/8.webm" poster={th8.src} controls />
</Gallery>
...
<Video src="/videos/2021/destiny/thewitcher3.webm" autoplay muted loop controls>
	La première fois qu'on entre dans un magasin de
	<Popup game="the-witcher-3-wild-hunt">*The Witcher 3*</Popup>, le contrôle nous est retiré pour nous
	informer que nous sommes bel et bien dans un magasin, avant de nous demander de retenir deux touches
	différentes sans que nous ne puissions les essayer sur le moment. En comparaison, dans Destiny, les
	touches utiles sont constamment affichées sur l'interface.
</Video>
...
import th9 from "./th9.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/9.webm" poster={th9.src} controls />
</Gallery>
...
import th10 from "./th10.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/10.webm" poster={th10.src} controls />
</Gallery>
...
<Video src="/videos/2021/destiny/vaisseau.webm" muted loop controls>
	Je vous la remets pour le plaisir !
</Video>
...
import th11 from "./th11.jpg"

<Gallery wide>
	<Video src="/videos/2021/destiny/11.webm" poster={th11.src} controls />
</Gallery>
