...
import metal from "./metal.gif"

<Figure src={import("./metal.gif")} alt='Texte "Metal" en lettres de feu'>
...
<Figure src={thumbnail}>
	[Cliquez ici pour charger le GIF animé](/videos/2021/remplacer-le-gif/exemple.gif) (1178×462 px,
	11,9 Mo)
</Figure>
